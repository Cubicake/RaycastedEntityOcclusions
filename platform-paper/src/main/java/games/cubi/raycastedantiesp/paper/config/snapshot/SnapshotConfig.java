package games.cubi.raycastedantiesp.paper.config.snapshot;

import games.cubi.raycastedantiesp.paper.config.Config;
import games.cubi.raycastedantiesp.paper.config.ConfigFactory;
import games.cubi.raycastedantiesp.paper.config.snapshot.block.BlockSnapshotConfig;
import games.cubi.raycastedantiesp.paper.config.snapshot.block.BukkitBlockSnapshotConfig;
import games.cubi.raycastedantiesp.paper.config.snapshot.entity.EntitySnapshotConfig;
import games.cubi.raycastedantiesp.paper.config.snapshot.tileentity.TileEntitySnapshotConfig;
