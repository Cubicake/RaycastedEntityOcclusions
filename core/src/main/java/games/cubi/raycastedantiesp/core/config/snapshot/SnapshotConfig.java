package games.cubi.raycastedantiesp.core.config.snapshot;

import games.cubi.raycastedantiesp.core.config.Config;
import games.cubi.raycastedantiesp.core.config.ConfigFactory;
import games.cubi.raycastedantiesp.core.config.snapshot.block.BlockSnapshotConfig;
import games.cubi.raycastedantiesp.core.config.snapshot.block.BukkitBlockSnapshotConfig;
import games.cubi.raycastedantiesp.core.config.snapshot.entity.EntitySnapshotConfig;
import games.cubi.raycastedantiesp.core.config.snapshot.tileentity.TileEntitySnapshotConfig;
